function predictions = getKeypointsJUMP(I, rect_roi, center_person, net, param)
% Given image, bbox, center of a person [x, y], network and parameters, this method 
% finds keypoint locations and returns it as [x1, y1, v1,...].
